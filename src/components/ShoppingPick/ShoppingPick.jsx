...
const ShoppingPick = () => {
	return (
		<section className="px-4 lg:pb-20 lg:px-24  bg-white">
			...
			>
				<SwiperSlide>
					<div className="bg-[#F0EBEB] pt-10 px-6 pb-4 w-max-[500px] w-full h-[560px]  max-w-[500px] drop-shadow-custom border border-black ">
				...
				<SwiperSlide>
					<div className="bg-[#F1F2FF] pt-10 px-6 pb-4  w-full h-[560px]  max-w-[500px] drop-shadow-custom border border-black">
						<h3 className="font-medium text-3xl text-center pb-3 font-inter">
							Want to shop online
						</h3>
				...
				<SwiperSlide>
					<div className="bg-[#F1F2FF] pt-10 px-6 pb-4  w-full h-[560px]   max-w-[500px] drop-shadow-custom border border-black">
						...
						<p className="font-normal text-lg text-center opacity-75 font-inter">
							With Firststore Retailer can customize there own store. your
							store, your way
						</p>
			...
			<div className="flex flex-col  md:flex-row md:justify-between gap-14 pt-4"></div>
		</section>
	);
};
